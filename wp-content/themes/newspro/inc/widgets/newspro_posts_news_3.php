...
class newspro_posts_news_3_widget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'newspro_news_block_3', 'description' => __('Posts News block 3', 'newspro'));
   ...
   <a href="'.esc_url(get_permalink()).'">
          <div class="newspro_post_news newspro_small_news" style="background-image: url('.$img_src.')">
          <div class="overlay">
				<div class="newspro_post_data">
                                               
								<span class="p_title">'.esc_attr($post_title).'</span>
								
								<div class="newspro_post_block_meta row">
