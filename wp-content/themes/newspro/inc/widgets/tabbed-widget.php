...
$title = apply_filters('widget_title', empty($instance['title']) ? '' : $instance['title'], $instance, $this->id_base);
        ...
        <?php
          ...
          echo '<div class="">';
                     echo '<ul class="menu-tab newspro_post_header-tab" role="tablist">';
          ...
          {   
              ...
              if ($value){
                 ...
                 echo '<li class="active"><a href="#'.esc_url(get_category_link( $key )).'" role="tab" data-toggle="tab">' . $category_array[]=$key . '</a></li>';
