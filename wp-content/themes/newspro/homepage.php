...
?>
  ...
  <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
    ...
    <?php dynamic_sidebar('newspro-homepage-main'); ?>
        ...
        <div class="newspro-home-columns clearfix">
          <?php if (is_active_sidebar('home-3')) { ?>
              <div class="newspro-widget-col-1 newspro-sidebar newspro-home-sidebar newspro-home-area-3">
                <?php dynamic_sidebar('home-3'); ?>
            </div>
          <?php } elseif (is_active_sidebar('home-4')) { ?>
            <div class="newspro-widget-col-1 newspro-sidebar newspro-home-sidebar newspro-home-area-3">
              <div class="newspro-widget newspro-home-3 newspro-sidebar-empty">
                <h4 class="newspro-widget-title">
                  <span class="newspro-widget-title-inner">
          ...
          <?php if (is_active_sidebar('home-4')) { ?>
              <div class="newspro-widget-col-1 newspro-sidebar newspro-home-sidebar newspro-margin-left newspro-home-area-4">
                <?php dynamic_sidebar('home-4'); ?>
            </div>
          <?php } elseif (is_active_sidebar('home-3')) { ?>
            <div class="newspro-widget-col-1 newspro-sidebar newspro-home-sidebar newspro-margin-left newspro-home-area-4">
              <div class="newspro-widget newspro-home-4 newspro-sidebar-empty">
                <h4 class="newspro-widget-title">
                  <span class="newspro-widget-title-inner">
